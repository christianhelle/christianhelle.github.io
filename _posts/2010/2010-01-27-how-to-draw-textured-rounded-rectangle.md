...
We create our brush with the [CreatePatternBrush](http://msdn.microsoft.com/en-us/library/ms908179.aspx?WT.mc_id=DT-MVP-5004822) function instead of [CreateSolidBrush](http://msdn.microsoft.com/en-us/library/ms959979.aspx?WT.mc_id=DT-MVP-5004822) as we did in my previous article on [How to draw a rounded rectangle in .NETCF](/2010/01/how-to-draw-rounded-rectangle-in-netcf.html). We will mostly use P/Invoke for creating and releasing GDI objects.  
