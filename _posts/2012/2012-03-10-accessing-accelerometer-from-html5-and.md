...
For this sample I would like to demonstrate how to access the [Accelerometer](https://learn.microsoft.com/en-us/previous-versions/ff707938(v=vs.110)?WT.mc_id=DT-MVP-5004822) sensor from HTML5 and Javascript. To make things more interesting, the Accelerometer reading data will be constantly updated every 100 milliseconds and .NET code will repeatedly call a Javascript method as Accelerometer reading data gets updated  
